...
exports.App = ({ basePath }) => {
    var _a, _b;
    const { state, selectedStatus, setSelectedStatus, promoteJob, retryJob, retryAll, cleanAllDelayed, cleanAllFailed, cleanAllCompleted, } = useStore_1.useStore(basePath);
